<head>
    ...
    <meta property="og:image" content="https://portafolio.bruix.io/clinicalasermedico/index.php">
    <!-- Favicon Icon -->
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/responsive.css?v2" />
    <!-- modernizr js -->
    ...
    })(window,document,'script','dataLayer','GTM-TNV553F');</script>
    ...
    fbq('init', '860425620971669'); 
    fbq('track', 'PageView');
    </script>
    <noscript>
    <img height="1" width="1" 
    src="https://www.facebook.com/tr?id=860425620971669&ev=PageView
    &noscript=1"/>
    </noscript>
